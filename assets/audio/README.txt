Drop your sound files in this folder using these names:

  ambience.mp3   creepy ambience, loops quietly under the whole site
...
Different file names or formats (.ogg, .m4a)? Edit CONFIG.audio at the top of script.js.
Keep files small (ambience under ~3MB, effects under ~500KB) so the site stays fast on mobile data.
